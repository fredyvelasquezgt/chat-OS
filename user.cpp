...
class User
{
    ...
    public string ip_address; // unique
    public int socket;
    ...
    {
        string data;
        data = "\t" + username + "\t" + ip_address + "\t" + User.get_status(status);
        return data;
    }

    public static string get_status(UserStatus status)
    {
    ...
    public void update_last_activity_time()
    {
